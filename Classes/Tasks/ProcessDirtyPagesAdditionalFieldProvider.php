<?php
namespace TYPO3\CMS\NcStaticfilecache;
/***************************************************************
 *  Copyright notice
 *
 ...
 * @access public
 */
class ProcessDirtyPagesAdditionalFieldProvider implements \TYPO3\CMS\Scheduler\AdditionalFieldProviderInterface {
	...
	public function validateAdditionalFields(array &$submittedData, \TYPO3\CMS\Scheduler\Controller\SchedulerModuleController $schedulerModule) {
		if (\TYPO3\CMS\Core\Utility\MathUtility::convertToPositiveInteger($submittedData['itemLimit']) > 0) {
			return true;
		} else {
